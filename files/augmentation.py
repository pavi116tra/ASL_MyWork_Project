...
# ══════════════════════════════════════════════════════════════════════════════
# LANDMARK AUGMENTATION (numpy-level)
# ══════════════════════════════════════════════════════════════════════════════
def _add_gaussian_noise(features: np.ndarray, sigma: float = 0.005) -> np.ndarray:
    """Add tiny Gaussian noise to feature vector."""
...
def _scale_jitter(features: np.ndarray,
    ...
    """Multiply all features by a random scale factor."""
    return features * random.uniform(lo, hi)

def _rotate_landmarks_2d(features: np.ndarray,
                          angle_deg: float) -> np.ndarray:
    """
    Apply a 2D rotation to the FIRST 15 joint-angle features only.
...
def _translate_landmarks(features: np.ndarray,
    ...
    """Small random translation (adds noise to distance-based features)."""
    out = features.copy()
...
# ══════════════════════════════════════════════════════════════════════════════
# IMAGE AUGMENTATION (OpenCV fallback)
# ══════════════════════════════════════════════════════════════════════════════
